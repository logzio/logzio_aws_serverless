...
For detailed information, read our [docs article](https://docs.logz.io/shipping/log-sources/cloudwatch.html).
...
\*LogGroup
You can find it in CloudWatch Page title of the log group for what you want to subscribe to receive logs, and transfer it to the logz.io.
